 ...
 *
 * The FAT image is embedded by the linker at FATIMG (0x81C00000 in sim):
 *   0x81C00000  = MBR / start of raw disk image
 *   0x81D00000  = FAT16 partition start (LBA 2048, 1 MB into image)
 *
 * All "disk I/O" is just pointer arithmetic — no real I/O needed.
 */

#define FAT_PART_BASE  ((uint8_t *)0x81D00000UL)
